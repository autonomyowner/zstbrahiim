              ...
              <div className="relative bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-8 py-8 overflow-hidden">
                ...
                <div className="relative">
                  ...
                  <p className="mt-2 text-sm text-slate-300" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                    Remplissez les informations ci-dessous pour créer une nouvelle annonce
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="form-field lg:col-span-2">
                    ...
                    <input
                      ...
                      className={`luxury-input w-full px-5 py-3.5 bg-white border-2 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 ${
                  ...
                  <div className="form-field">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className={`luxury-input w-full pl-5 pr-12 py-3.5 bg-white border-2 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 ${
                  ...
                  <div className="form-field">
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="luxury-input w-full pl-5 pr-12 py-3.5 bg-white border-2 border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10"
                        min="0"
                        step="100"
                        placeholder="0"
                        style={{ fontFamily: "'DM Sans', sans-serif" }}
                  ...
                  <div className="form-field">
                    ...
                    <input
                      ...
                      className="luxury-input w-full px-5 py-3.5 bg-white border-2 border-slate-200 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10"
                  ...
                  <div className="form-field lg:col-span-2">
                    ...
                    <textarea
                      ...
                      rows={4}
                      className={`luxury-input w-full px-5 py-3.5 bg-white border-2 rounded-xl text-slate-900 placeholder:text-slate-400 focus:outline-none focus:border-amber-500 focus:ring-4 focus:ring-amber-500/10 resize-none ${
                  ...
                  {/* Image & Video Upload */}
                  <div className="form-field lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                    {/* Image Upload */}
                  ...
                  {/* Status Toggles */}
                  <div className="form-field lg:col-span-2 bg-gradient-to-br from-slate-100 to-slate-50 rounded-xl p-6 border border-slate-200">
